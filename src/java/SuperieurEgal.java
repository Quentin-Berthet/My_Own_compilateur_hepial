/*
 * Represent a superior or equal comparaison expression node inside the AST.
 */

public class SuperieurEgal extends Relation {
    /**
     * Constructor
     */
    public SuperieurEgal(String fl, int line, int col) {
        super(fl, line, col);
    }
