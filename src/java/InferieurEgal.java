/*
 * Represent a less or equal comparaison expression node inside the AST.
 */

public class InferieurEgal extends Relation {
    /**
     * Constructor
     */
    public InferieurEgal(String fl, int line, int col) {
        super(fl, line, col);
    }
